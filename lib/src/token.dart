...
class RsaSha1Tokens extends Tokens {
  ...
  bool verify(List<int> signature, List<int> body) {
    ...
    var params = new ParametersWithRandom(
        new PublicKeyParameter(publicKey), new FortunaRandom());
